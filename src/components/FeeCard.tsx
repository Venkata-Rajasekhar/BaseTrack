...
const FeeCard: FC<FeeCardProps> = ({ transactions }) => {
  ...
  return (
    <div className="fee-card p-6 mb-4 bg-white border border-gray-200 ro unded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-8 dark:bg-gray-800 hover:bg-blue-50 transform hover:scale-105 transition">
